...
export const ROUTE_IEC62443_PATH = 'iec62443';
export const ROUTE_IEC62443 = `/${ROUTE_WORKSPACE_PATH}/${ROUTE_IEC62443_PATH}`;
export const ROUTE_IEC62443_4_2_PATH = 'iec62443-4-2';
export const ROUTE_IEC62443_4_2 = `/${ROUTE_WORKSPACE_PATH}/${ROUTE_IEC62443_4_2_PATH}`;
export const ROUTE_VULNERABILITY_ASSESSMENT_PATH = 'vulnerability-assessment';
export const ROUTE_VULNERABILITY_ASSESSMENT = `/${ROUTE_WORKSPACE_PATH}/${ROUTE_VULNERABILITY_ASSESSMENT_PATH}`;
export const ROUTE_VIEW_THREAT_MODEL_EXECUTIVE_PATH = 'threatModelExecutive';
export const ROUTE_VIEW_THREAT_MODEL_EXECUTIVE = `/${ROUTE_WORKSPACE_PATH}/${ROUTE_VIEW_THREAT_MODEL_EXECUTIVE_PATH}`;
export const ROUTE_VIEW_THREAT_MODEL_OPERATIONAL_PATH = 'threatModelOperational';
export const ROUTE_VIEW_THREAT_MODEL_OPERATIONAL = `/${ROUTE_WORKSPACE_PATH}/${ROUTE_VIEW_THREAT_MODEL_OPERATIONAL_PATH}`;
export const ROUTE_VIEW_THREAT_MODEL_INTERNAL_PATH = 'threatModelInternal';
export const ROUTE_VIEW_THREAT_MODEL_INTERNAL = `/${ROUTE_WORKSPACE_PATH}/${ROUTE_VIEW_THREAT_MODEL_INTERNAL_PATH}`;
